    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`${collapsed ? 'w-16' : 'w-64'} bg-white shadow-lg transition-all duration-200 relative`}>
        ...
        <nav className="mt-6">
          ...
          <Link href="/admin/announcements" title="Announcements" className={`flex items-center ${collapsed ? 'justify-center py-3' : 'px-6 py-3'} text-gray-700 hover:bg-gray-200 hover:text-gray-900`}>
            <span className="w-8 h-8 flex items-center justify-center rounded-md bg-gray-100 text-sm font-medium">{collapsed ? 'An' : ''}</span>
            {!collapsed && <span className="ml-3">Announcements</span>}
          </Link>
          <Link href="/admin/footer" title="Footer" className={`flex items-center ${collapsed ? 'justify-center py-3' : 'px-6 py-3'} text-gray-700 hover:bg-gray-200 hover:text-gray-900`}>
            <span className="w-8 h-8 flex items-center justify-center rounded-md bg-gray-100 text-sm font-medium">{collapsed ? 'F' : ''}</span>
            {!collapsed && <span className="ml-3">Footer</span>}
          </Link>
